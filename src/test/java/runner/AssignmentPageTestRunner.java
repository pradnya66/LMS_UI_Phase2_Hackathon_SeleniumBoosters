...
//@Test
@CucumberOptions(
		features = "src/test/resources/features/ManageUserfeatures", 
		glue = "ManageUserStepDefinitions", 
//		//"LogInPageStepDefinitions","homePageStepDefinitions","ProgramPageStepDefinitions"},
		//tags = "@tag1",
//		//monochrome = true,
//		//dryRun = true,
...
public class AssignmentPageTestRunner extends AbstractTestNGCucumberTests
 {
