...
public class ResultsInDescendingOrderStepDefs extends BaseClass {

	 TestContext testcontext;
		
		public ResultsInDescendingOrderStepDefs(TestContext testcontext) {
			this.testcontext = testcontext;
		}
	
	
	@Then("User should see the results in Descending order of Program name -ProgramPage")
	public void user_should_see_the_results_in_descending_order_of_program_name_program_page() throws Exception {
		Thread.sleep(5000);
		List<String> afterNameList = testcontext.getProgramObj().getProgramNames();
		List<String> ExpNameList  = afterNameList;
		Collections.sort(ExpNameList, Collections.reverseOrder());
	...
	public void user_should_see_the_results_in_descending_order_of_program_description_program_page() throws Exception {
		Thread.sleep(3000);
	...
	public void user_should_see_the_results_in_descending_order_of_program_status_program_page() throws Exception {
		Thread.sleep(3000);
		List<String> afterStatusList = testcontext.getProgramObj().getProgramStatus();
		List<String> ExpStatList  = afterStatusList;
		 Collections.sort(ExpStatList, Collections.reverseOrder());
